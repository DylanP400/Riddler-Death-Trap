...
const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Robert Pattison', correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Calender Man', correct: false },
            { text: 'Man Bat', correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Brendan Fraser', correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Batman vs Superman', correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: 'Dany Devito', correct: true },
            { text: 'Colin Farrell', correct: false },
            { text: 'Robin Lord Taylor', correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: 'Batman: Hush', correct: false },
            { text: 'Batman: Under the Red Hood', correct: false },
            { text: 'Batman Beyond: Return of the Joker', correct: true },
            { text: 'Batman: The killing joke', correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: 'Batman Begins', correct: false },
            { text: 'Batman Returns ', correct: true },
            { text: 'The Batman', correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: 'The Batsignal', correct: true },
            { text: 'The Batlamp', correct: false },
            { text: 'The Batlight', correct: false },
            { text: 'The Batsign', correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: 'The Batman', correct: false },
            { text: 'Batman: Death in the Family', correct: false },
            { text: 'Batman Forever', correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Braver', correct: false }
        ]
    },
    {
        question: 'What is Commissioner Gordon’s first name?',
        answers: [
            { text: 'John', correct: false },
            { text: 'Mike', correct: false },
            { text: 'James', correct: true },
            { text: 'Rick', correct: false }
        ]
    }];